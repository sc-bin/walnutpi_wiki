...
::::tip Note:
You can also configure this by modifying the `screen` parameter in /boot/config.txt: `screen=lcd15-st7789`. [config.txt Display Configuration Tutorial](../config.txt.md#display-configuration)
::::
